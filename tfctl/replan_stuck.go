...
func (c *CLI) ReplanStuck(ctx context.Context, out io.Writer, resource string) error {
...
func replan_stuck(ctx context.Context, kubeClient client.Client, namespacedName types.NamespacedName) error {
